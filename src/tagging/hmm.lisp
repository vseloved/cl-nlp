...
(defmethod train ((model hmm) data &rest args
                  ...
                  &allow-other-keys)
  "Train HMM MODEL on a list of tagged sentences DATA
   (using language models classes TRANSITION-LM-CLASS and EMISSION-LM-CLASS)."
  (declare (ignore args))
...
(defun make-hmm (tags data &key (order 2)
  ...
  (train (make 'hmm :order order :tags tags)
         data
